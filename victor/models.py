...
#from keras_applications.inception_resnet_v2 import inception_resnet_block
from keras.applications.densenet import DenseNet121
#from keras_applications.densenet import dense_block, transition_block

bn_axis = 3
channel_axis = bn_axis
def conv_blockk(x, growth_rate, name):
...
def dense_block(x, blocks, name):
    ...
    for i in range(blocks):
        x = conv_blockk(x, 32, name=(name + '_block' + str(i + 1)))
    return x
